...
$mode="search";
	if($_REQUEST["del"]){
		...
		$del_id = $_REQUEST["del"];
		//del_flag立てる
		$del_sql = "UPDATE dtb_event_client_school SET del_flag = '1' WHERE client_id = '$del_id' ";
	...
	$k_sql = "SELECT m.*, d.*, se.* FROM mtb_client AS m , dtb_entry_client_event AS d, mtb_school_event AS se WHERE se.event_id = d.event_id AND m.client_id = d.client_id AND m.del_flag = '0' AND d.del_flag = '0' AND se.school_id = '$school_id' ";
...
$mode="edit";
	...
	//情報引き出し
	$sql = "SELECT m.*, d.*, se.* FROM mtb_client AS m , dtb_entry_client_event AS d, mtb_school_event AS se WHERE se.event_id = d.event_id AND m.client_id = d.client_id AND m.del_flag = '0' AND d.del_flag = '0' AND se.school_id = '$school_id' AND d.client_id = '$client_id' ";
...
?>
									<tr>
										...
										<td class="center"><?=$k_data["event_date"]?></td>

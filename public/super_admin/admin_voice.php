						...
						<form class="form-search" action="" method="post">
							...
							<div class="con">
								...
								<div class="q_box">
									...
									<div class="q_con">
										<label><input type="radio" name="key_school_type" value="" <?if($_SESSION["key_school_name"]==""){echo "checked";}?>/>すべて</label>　　
										<?foreach($SCHOOL_TYPE_ARY as $k=>$val){?>
										<label><input type="radio" name="key_school_type" value="<?=$k?>" <?if($_SESSION["key_school_name"]==$k){echo "checked";}?>/><?=$val?></label>　　
										<?}?>
									</div>
								</div>
								<div class="q_box">

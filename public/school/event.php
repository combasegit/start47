...
//メタ情報
$PAGE_TITLE=$school_name."イベント・行事";
$PAGE_DESCRIPTION=$school_name."のイベント・行事についてご案内いたします。";
$PAGE_KEYWORDS=$school_name.",イベント,行事,通信制高校";
...
?>
	<main>
		<div class="bread_list">
			<a href="/">ホーム</a>&nbsp;&gt;&nbsp;<a href="/search/">学校を探す</a>&nbsp;&gt;&nbsp;<a href="/search/<?=$AREA_E[$THIS_SCHOOL_AREA]?>/"><?=$AREA[$THIS_SCHOOL_AREA]?></a>&nbsp;&gt;&nbsp;<a href="/search/<?=$AREA_E[$THIS_SCHOOL_AREA]?>/<?=$PREFECTURE_E[$THIS_SCHOOL_PREF]?>/"><?=$PREFECTURE[$THIS_SCHOOL_PREF]?></a>&nbsp;&gt;&nbsp;<a href="./"><?=$school_name?></a>&nbsp;&gt;&nbsp;イベント・行事
		</div>
	<?if($err==1){?>
		<article id="main_box">

...
//メタ情報
$PAGE_TITLE=$school_name."キャンパス所在地";
$PAGE_DESCRIPTION=$school_name."のキャンパス所在地についてご案内いたします。";
$PAGE_KEYWORDS=$school_name.",キャンパス,アクセス,交通,通信制高校";
...
?>
	<main>
		<div class="bread_list">
			<a href="/">ホーム</a>&nbsp;&gt;&nbsp;<a href="/search/">学校を探す</a>&nbsp;&gt;&nbsp;<a href="/search/<?=$AREA_E[$THIS_SCHOOL_AREA]?>/"><?=$AREA[$THIS_SCHOOL_AREA]?></a>&nbsp;&gt;&nbsp;<a href="/search/<?=$AREA_E[$THIS_SCHOOL_AREA]?>/<?=$PREFECTURE_E[$THIS_SCHOOL_PREF]?>/"><?=$PREFECTURE[$THIS_SCHOOL_PREF]?></a>&nbsp;&gt;&nbsp;<a href="./"><?=$school_name?></a>&nbsp;&gt;&nbsp;キャンパス所在地
		</div>
	<?if($err==1){?>
		<article id="main_box">
			...
			<article id="detail_box">
				...
				<div class="data_box">
					...
					<table class="campus_data">
						...
						<tr>
							<td colspan="2"><iframe width="100%" height="300" frameborder="0" marginwidth="0" marginheight="0" src="https://maps.google.co.jp/maps?q=<?=$PREFECTURE[$val[pref]]?><?=$val[address]?>&output=embed&t=m"></iframe></td>
						</tr>
						<tr>
							<th>所在地</th>
